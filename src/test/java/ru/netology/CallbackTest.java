...
public class CallbackTest {
    ...
    void shouldNotifyAboutEmptyName() {
        ...
        $("[data-test-id=agreement]").click();
        $("button").click();
        $("[data-test-id=name].input_invalid .input__sub").shouldBe(visible, exactText("Поле обязательно для заполнения"));
    }
    ...
    void shouldNotifyAboutEmptyPhone() {
        ...
        $("[data-test-id=agreement]").click();
        $("button").click();
        $("[data-test-id=phone].input_invalid .input__sub").shouldBe(visible, exactText("Поле обязательно для заполнения"));
    }
